...
lib.foldr lib.recursiveUpdate {} [
  ...
  (import ./dell-latitude-7330-laptop.nix {inherit self lib nixos-generators nixos-hardware microvm;})
  (import ./dell-latitude-7230-tablet.nix {inherit self lib nixos-generators nixos-hardware microvm;})
